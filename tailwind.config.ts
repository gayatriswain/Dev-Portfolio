...
export default {
  darkMode: ["class"],
  content: ["./client/**/*.{ts,tsx,js,jsx}", "./app/**/*.{ts,tsx,js,jsx}"],
  prefix: "",
  theme: {
    container: {
      center: true,
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-brand-radial":
          "radial-gradient(circle at center, hsl(var(--gradient-start)), hsl(var(--gradient-mid)), hsl(var(--gradient-end)))",
      },
      borderRadius: {
        lg: "var(--radius)",
